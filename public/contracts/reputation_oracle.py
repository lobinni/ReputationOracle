...
class ReputationOracle(gl.Contract):
    ...
    def create_profile(
        ...
        """Register an entity and take its baseline reputation assessment.
        
        This simplified version takes a single URL instead of multiple sources.
        """
        ...
        profile.total_assessments = u32(1)
    ...
    def assess(self, profile_id: u256) -> None:
        ...
        if digest == str(profile.signals_digest):
    ...
    def get_profile(self, profile_id: u256) -> dict:
        ...
        return {
            ...
            "degraded": degraded,
            "reliable": bool(profile.active) and not degraded,
        }
